...
%%% VARIABLES
%F = 100;  % Frame
ImgPath = 'Y:\PIV\PROJECTS\MH7\Raw\Rectified';
VectorPath = 'Y:\PIV\PROJECTS\MH7\Raw\Rectified\Vectors';
...
exportname = fullfile('Y:\PIV\PROJECTS\MH7\',['export-',num2str(F),'.pdf']);
