...
%% Create a second figure (small, 4 import)
...
hDisplayGridRadioButton = uicontrol(...
    ...
    'String','display grid',...
    'Units', 'pixels', ...
    'Position',[0 65 150 30]);

hDisplayStrainRadioButton = uicontrol(...
    'Parent', hbgvector,...
    'Style','radiobutton',...
    'HorizontalAlignment','left',...
    'String','display strain',...
    'Units', 'pixels', ...
    'Position',[0 0 150 30]);
...
htextVecGridFactor = uicontrol(...
    ...
    'Units', 'pixels', ...
    'FontSize',10,...
    'Position',[10 295 150 20]);

htextVecGridColor = uicontrol(...
    'Style','text', ...
    'String','Grid color :',...
    'Parent', hDisplayFigure, ...
    'HorizontalAlignment','left',...
...
%align([hIMGcheckbox,htextMinBackgroundColorPalette], 'None','Middle');
...
% make group with options vector / def grid / Principal strain
...
hDisplayVectorRadioButton = uicontrol(hbgvector,...
    'Style','radiobutton',...
