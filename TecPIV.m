...
hImgNumber = uicontrol(...
    ...
    % Lagrangian tracers
    hAddLagrangianTracersMenuItem = uimenu(...
        'Parent',hPIVPostprocessMenu,...
...
for folding = true
    ...
    hpopupBackgroundCPTSelector = uicontrol(...
        ...
        'Parent', hDisplayFigureIMG, ...
        'Units', 'pixels', ...
        'Position',[85 70 100 30]);
    
    htextMinBackgroundColorPalette = uicontrol(...
        'Style','text', ...
        'String','min/max image:',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
        'Parent', hDisplayFigureIMG, ...
        'Units', 'pixels', ...
...
for folding = true
    ...
    hmaskColorDropdown = uicontrol(...
        'Style','popupmenu',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
        'String',{'green','blue','black','red',  'yellow', 'cyan', 'magenta','white'},...
        'Parent', hDisplayFigure, ...
        'Units', 'pixels', ...
        'Position',[70 70 125 20]);
    
    align([hmaskColorLabel hmaskColorDropdown],'None', 'Middle');

    hmaskLineWidthLabel = uicontrol(...
        'Style','text', ...
        'String','line width:',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
    ...
    hmaskLineWidthDropdown = uicontrol(...
        'Style','popupmenu',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
        'String',{'0.5', '1',  '1.5', '2'},...
        'Parent', hDisplayFigure, ...
        'Units', 'pixels', ...
        'Position',[70 50 125 20]);
    
    align([hmaskLineWidthLabel hmaskLineWidthDropdown],'None', 'Middle');
    ...
    hroicheckbox = uicontrol(...
        ...
        'Units', 'pixels', ...
        'value', 0, ...
        'Position',[210 95 150 20]);
    
    hroiColorLabel = uicontrol(...
        'Style','text', ...
        'String','color:',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
        'Parent', hDisplayFigure, ...
        'Units', 'pixels', ...
        'Position',[210 70 100 20]);
    
    hroiColorDropdown = uicontrol(...
        'Style','popupmenu',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
        'String',{'red','blue','black', 'green', 'yellow', 'cyan', 'magenta','white'},...
        'Parent', hDisplayFigure, ...
        'Units', 'pixels', ...
        'Position',[270 70 125 20]);
    
    align([hroiColorLabel hroiColorDropdown],'None', 'Middle');

    hroiLineWidthLabel = uicontrol(...
        'Style','text', ...
        'String','line width:',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
    ...
    hroiLineWidthDropdown = uicontrol(...
        'Style','popupmenu',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
        'String',{'0.5', '1',  '1.5', '2'},...
        'Parent', hDisplayFigure, ...
        'Units', 'pixels', ...
        'Position',[270 50 125 20]);
    
    align([hroiLineWidthLabel hroiLineWidthDropdown],'None', 'Middle');
    ...
    htextScalarType = uicontrol(...
        ...
        'Units', 'pixels', ...
        'value', 1, ...
        'Position',[210 170 60 20]);
    
    align([hscalarcheckbox htextScalarType hpopupVecDerivativeTypeSelector],'None', 'Middle');
    align([htextScalarColorPalette hpopupScalarCPTSelector htextVecDerivativeDisplayRange hpopupVecDerivativeDisplayRangeSelector],'None', 'Middle');
    align([hInterpDerivativetext hpopupVecDerivativeMethodSelector htextMinScalarColorPalette hMinScalarColorPalette hMaxScalarColorPalette],'None', 'Middle');

  %% show scale bar  
    hscalebarcheckbox = uicontrol(...
        'Style','checkbox', ...
        ...
        'Units', 'pixels', ...
        'Value', 1, ...
        'Position',[10 195 480 20]);
    
    hpopupVecDerivativeDisplayRangeSelector = uicontrol(...
        'Style','popupmenu',...
        'FontSize',MyFontSize,...
        'HorizontalAlignment','left',...
        'String',{'1','2','5','10', '20', '50', '100'},...
        'Parent', hDisplayFigure, ...
        'Units', 'pixels', ...
        'Position',[270 195 125 20]);
...
for folding = true
    myhandles.TracerInit = {}; % initialize cell array
    pad = 5; % padding
    DFN = 2; % default frame number
...
function AddParamLagrangianTracers(~,~)
    ...
    TracerNumS = uiTracerNum.String;
    
    VAR_Tracer = str2double(TracerNumS);
    VAR_Frame = str2double(FrameNumS);
    VAR_Param_Name = char(PopMenS(PopMenV));
    
    myhandles.TracerInit{VAR_Tracer, 1} = VAR_Tracer;
    myhandles.TracerInit{VAR_Tracer, 2} = VAR_Frame;
    
    Line = myhandles.TracerInit(VAR_Tracer,:);
    S = size(Line);
    
    POS = 5; % first parameter in position 5
    if S(2) < POS
        % no parameter entered yet
        myhandles.TracerInit{VAR_Tracer, POS} = VAR_Param_Name;
    else
        TF = isempty(myhandles.TracerInit{VAR_Tracer, POS});
