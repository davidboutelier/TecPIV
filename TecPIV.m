...
hCalibrateFigure = figure(...
    ...
    'HandleVisibility','callback', ...
    'Resize','off',...
    'CloseRequestFcn', @CloseRequestCalibrateFigure, ...
    'Color', get(groot,...
    'defaultuicontrolbackgroundcolor'));
...
hRotateFigure = figure(...
    ...
    'HandleVisibility','callback', ...
    'Resize','off',...
    'CloseRequestFcn', @CloseRequestRotateFigure, ...
    'Color', get(groot,...
    'defaultuicontrolbackgroundcolor'));
...
hContrastFigure = figure(...
    ...
    'HandleVisibility','callback', ...
    'Resize','off',...
    'CloseRequestFcn', @CloseRequestContrastFigure, ...
    'Color', get(groot,...
    'defaultuicontrolbackgroundcolor'));
...
hPIVSettingsFigure = figure(...
    ...
    'HandleVisibility','callback', ...
    'Resize','off',...
    'CloseRequestFcn', @CloseRequestPIVFigure, ...
    'Color', get(groot,...
    'defaultuicontrolbackgroundcolor'));
...
for folding = true
    ...
    T = hStartControlPointsExtraction.Extent;
    hStartControlPointsExtraction.Position(1) = P(3) - T(3) -35;
...
for folding = true
    ...
    T = hStartRectifyCalib.Extent;
    hStartRectifyCalib.Position(1) = P(3) - T(3) -35;
...
for folding = true
    ...
    T = hStartUndeform.Extent;
    hStartUndeform.Position(1) = P(3) - T(3) -35;
